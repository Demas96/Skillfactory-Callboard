...
from main.models import Advertisement, User
...
def my_job():
    ...
    adv_for_day_send = Advertisement.objects.filter(time_create__range=(start_date, end_date))
    html_content = render_to_string('email/send.html', {'advs': adv_for_day_send}, )
    email = set()
